...
*   User timezone preference (backend schema, API, frontend UI).
*   Task priority (backend schema, API, frontend UI).
*   Task start/stop tracking (backend schema, API, frontend UI).
*   Task time spent summary and display using Recharts (backend API, frontend UI).
